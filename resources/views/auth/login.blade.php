...
<body class="body-bg-full profile-page">
    <div id="wrapper" class="wrapper">
        <div class="row container-min-full-height">
                ...
                <div class="w-50">
                    ...
                    <form action="\login" method="post" class="text-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" placeholder="johndoe@site.com" class="form-control form-control-line" name="email" value="{{ old('email','scott@gmail.com') }}">
                        </div>
                        <div class="form-group">
            ...
            <div class="col-lg-4 login-right d-lg-flex d-none pos-fixed pos-right text-inverse container-min-full-height" style="background-image: url({{ asset('thema/') }}/assets/demo/login-page-bg.jpg)">
    ...
    <script type="text/javascript" src="{{ asset('thema/') }}/assets/js/material-design.js"></script>
</body>
