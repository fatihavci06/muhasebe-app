...
@endsection
@section('module1')Finansal @endsection
...
$(function() {
    myDataTable=$('#dataTable').DataTable({
        ...
        columns: [
            { data: 'Type', name: 'Type' },//yukarıda routtan çektiğimiz dataları burada tabloya sıra sıra yazdırdık. ancak datatablede burada data kdar sutun olmalı
            { data: 'name', name: 'name' },
            { data: 'kdv', name: 'kdv' },
           {data: 'action', name: 'action', orderable: false, searchable: false}, //controllerdan dönen addcolumnuda burada belirtmek zorundayız.
