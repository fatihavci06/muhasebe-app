                                ...
                                <div class="single media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="single-gallery row">
                                            <figure class="col-6">
                                                <a class="d-block" href="{{ asset('thema/') }}/assets/demo/status-gallery-1.jpg">
                                                    <img class="w-100" src="{{ asset('thema/') }}/assets/demo/status-gallery-1-thumb.jpg">
                                                </a>
                                            </figure>
                                            <!-- /.col-6 -->
                                            <figure class="col-6">
                                                <a class="d-block" href="{{ asset('thema/') }}/assets/demo/status-gallery-2.jpg">
                                                    <img class="w-100" src="{{ asset('thema/') }}/assets/demo/status-gallery-2-thumb.jpg">
                                                </a>
                                            </figure>
                                            <!-- /.col-6 -->
                                        </div>
                                ...
                                <div class="single media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="single-users-list">
                                            <a href="#">
                                                <img src="{{ asset('thema/') }}/assets/demo/users/user6.jpg">
                                            </a>
                                            <a href="#">
                                                <img src="{{ asset('thema/') }}/assets/demo/users/user5.jpg">
                                            </a>
                                            <a href="#">
                                                <img src="{{ asset('thema/') }}/assets/demo/users/user4.jpg">
                                            </a>
                                            <a href="#">
                                                <img src="{{ asset('thema/') }}/assets/demo/users/user3.jpg">
                                            </a>
                                            <a href="#">
                                                <img src="{{ asset('thema/') }}/assets/demo/users/user2.jpg">
                        ...
                        <div class="widget-body">
                            <div class="cursor-move carousel" data-slick='{"slidesToShow": 1, "dots": true, "arrows": false}'>
                                <article>
                                    <div class="row">
                                        <figure class="col-5 post-img">
                                            <img src="{{ asset('thema/') }}/assets/demo/blog-post-1.jpg" alt="A book is a dream that you hold in your hands">
                                        </figure>
                                        <div class="col-7 post-details">
                                            ...
                                            <div class="post-links">
                                                <figure>
                                                    <a href="#">
                                                        <img class="rounded-circle" src="{{ asset('thema/') }}/assets/demo/users/user1.jpg" alt="User 1">
                                                    </a>
                                                </figure>
                                                <ul>
                                ...
                                <article>
                                    <div class="row">
                                        <figure class="col-5 post-img">
                                            <img src="{{ asset('thema/') }}/assets/demo/blog-post-2.jpg" alt="A book is a dream that you hold in your hands">
                                        </figure>
                                        <div class="col-7 post-details">
                                            <h5 class="box-title">Latest Posts</h5>
                                            <h4 class="post-title"><a href="#">A book is a dream that you hold in your hands</a></h4>
                                ...
                                <article>
                                    <div class="row">
                                        <figure class="col-5 post-img">
                                            <img src="{{ asset('thema/') }}/assets/demo/blog-post-3.jpg" alt="A book is a dream that you hold in your hands">
                                        </figure>
                                        <div class="col-7 post-details">
                                            <h5 class="box-title">Latest Posts</h5>
                                            <h4 class="post-title"><a href="#">A book is a dream that you hold in your hands</a></h4>
                            ...
                            <div class="widget-actions">
                                <div class="float-right user-avatar-list"><a href="#" class="thumb-xxs more-link">+24</a>
                                    <a href="#" class="thumb-xxs">
                                        <img src="{{ asset('thema/') }}/assets/demo/users/user2.jpg" class="rounded-circle" alt="User 2">
                                    </a>
                                    <a href="#" class="thumb-xxs">
                                        <img src="{{ asset('thema/') }}/assets/demo/users/user3.jpg" class="rounded-circle" alt="User 3">
                                    </a>
                                    <a href="#" class="thumb-xxs">
                                        <img src="{{ asset('thema/') }}/assets/demo/users/user4.jpg" class="rounded-circle" alt="User 4">
                                    </a>
                                    <a href="#" class="thumb-xxs">
                                        <img src="{{ asset('thema/') }}/assets/demo/users/user5.jpg" class="rounded-circle" alt="User 5">
                                    </a>
                                </div>
                                <!-- /.user-avatar-list -->
                            </div>
                                ...
                                <div class="profile-body">
                                    <figure class="profile-user-avatar thumb-md">
                                        <a href="page-profile.html">
                                            <img src="{{ asset('thema/') }}/assets/demo/users/user1.jpg" alt="User Wall">
                                        </a>
                                    </figure>
                            ...
                            <div class="widget-todo">
                                ...
                                <div class="single media"><i class="single-icon feather feather-circle color-success"></i>
                                    ...
                                    <div class="user-avatar-list align-self-center mr-3">
                                        <a href="#" class="thumb-xxs">
                                            <img src="{{ asset('thema/') }}/assets/demo/users/user5.jpg" class="rounded-circle" alt="User 2">
                                        </a>
                                    </div>
                                    <!-- /.user-avatar-list -->
                                    <div class="dropdown align-self-center"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="feather feather-more-vertical"></i></a>
